...
| Commander une liste à cocher | `barreListeHTML` + `bindBarreListe` (`ui/affiner.js`) — **UNE rangée** : la case « tout » et son compte, la recherche, `Affiner`, le pli. Elle REMPLACE les deux rangées d'avant (le compte et son pli au-dessus, « Tout » et « Affiner » en dessous), donc la recherche arrive sans coûter un pixel de hauteur — au-dessus d'une liste, sur un téléphone, la hauteur est ce qui coûte le plus cher. **La case d'en-tête se passe du mot « Tout » parce qu'elle tient l'AXE des cases de la liste** : c'est la position universelle du « tout cocher », et c'est ce qui la rend lisible sans libellé. Décalée, elle redevient une icône orpheline et il lui faut son mot — d'où une garde à ±2 px. À texte doublé la barre se replie (WCAG 1.4.10) plutôt que de rogner. Les trois feuilles qui choisissent des pistes l'emploient : Donner, Prospecter, partage en groupe |
