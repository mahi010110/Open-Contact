...
//! scelle avec `sealValue`, l’ordinateur ouvre ici, et inversement.
...
/// la PWA (`ui/ordinateur.js`). Changer = casser l'appairage.
...
mod tests {
    ...
    /* vecteurs générés par le moteur JS (WebCrypto) — s'ils cassent,
       le format du canal a changé et la PWA ne parle plus à l’ordinateur */
    #[test]
