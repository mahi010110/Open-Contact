//! Les secrets de l’ordinateur (clé de canal, graine d'identité, plus
...
const SERVICE: &str = "OpenContact Ordinateur";
...
impl Secrets {
    ...
    pub fn ecrire(&self, nom: &str, val: &[u8]) -> bool {
        ...
        if fs::write(&p, &s).is_ok() {
            ...
            eprintln!("ordinateur : trousseau indisponible — « {nom} » gardé en fichier protégé");
            return true;
        }
        false
    }
